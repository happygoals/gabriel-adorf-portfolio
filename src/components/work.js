...
const BMWLink = <a href="https://drive.google.com/file/d/1BQDRDp9zB7wnmT2Y8-V1Cqo7ibkfhxBc/view?usp=sharing">Read More</a>
const BMWLink2 = <a href="https://vimeo.com/392362212">Watch Demo on Vimeo ↗</a>
const ParkviewLink = <Link to="/parkview">Read More</Link>
const ParkviewLink2 = <a href="https://vimeo.com/392359571/6adb6cafd8">Watch Demo on Vimeo ↗</a>
const Work = () => {
  return (
    <TwoColumns
      wide
      ...
      rightColumn={
        <Fragment>
          ...
          <Project
            ...
            abstract="This project is a web application that analyzes and presents created data in a heatmap and a chart of frequent routes. Parkview hospital could understand routing patterns with the framework and optimize space utilization for people with disabilities."
            link={ParkviewLink}
            link2={ParkviewLink2}
          />
        </Fragment>
